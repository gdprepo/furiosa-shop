                    ...
                    <!-- 
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row" class="border-0">
                                        <div class="p-2">
                                            ...
                                            <div style="margin: 0px !important" class="ml-3 d-inline-block align-middle">
                                                <h5 style="font-size: smaller" class="mb-0 mt-2"> <a href="{{ route('shop.show',  $product->id) }}" class="text-dark d-inline-block align-middle">{{ $product->model->title }}
                                                        @if ($product->options != "[]")
                                                        - {{ $product->options }}
                                                        @endif
                                    ...
                                    <td style="padding: 0px; width: 20%" class="border-0 align-middle"><strong>{{ getPrice(floatval($product->subtotal())* 1000) }}</strong></td>
                              <!--      <td class="border-0 align-middle">
                                    ...
                                    <td class="border-0 align-middle">
                                        <form action="{{ route('cart.destroy', $product->rowId) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger" style="width: 80%; padding: 5px"><i style="font:normal normal normal 14px/1 FontAwesome;" class="fas fa-trash"></i></a>
                                        </form>
                                    </td>
                                </tr>
                                @endforeach
                ...
                <div class="col-md-6" style="padding-bottom: 30px">
                    ...
                    <div class="">
                        ...
                        <ul class="list-unstyled mb-4">
                            ...
                            @if (getPrice(floatval(Cart::subtotal()) * 1000) >= 59.99)
                            ...
                            @if (getPrice(floatval(Cart::subtotal()) * 1000) >= 59.99)
                                <h5 class="font-weight-bold">{{ getPrice(floatval(Cart::total())* 1000)  }}</h5>
                                    ...
                                    <th scope="row" class="border-0">
                                        <div class="p-2">
                                            ...
                                            <div class="ml-3 d-inline-block align-middle">
                                                <h5 class="mb-0"> <a href="{{ route('shop.show', ['slug' => $product->model->slug]) }}" class="text-dark d-inline-block align-middle">{{ $product->model->title }}
